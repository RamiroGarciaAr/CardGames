...
public class MyGdxGame extends ApplicationAdapter{
	...
	private void LoadBackgroundImage(String name) {

		FileHandle fileHandle = Gdx.files.internal("assets/Backgrounds/" + name);
		if (fileHandle.exists())
		{
			if (fileHandle.extension().equals(".png") || fileHandle.extension().equals(".jpg"))
			{
				backgroundTexture = new Texture(fileHandle);
			}
		}
	}
